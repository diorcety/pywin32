...
PYWIN_MODULE_INIT_FUNC(win32console)
{
	...
	PyModule_AddIntConstant(module, "ENABLE_INSERT_MODE", ENABLE_INSERT_MODE);
	PyModule_AddIntConstant(module, "ENABLE_EXTENDED_FLAGS", ENABLE_EXTENDED_FLAGS);
	...
	PyModule_AddIntConstant(module, "ENABLE_QUICK_EDIT_MODE", ENABLE_QUICK_EDIT_MODE);
#ifdef ENABLE_VIRTUAL_TERMINAL_INPUT
	PyModule_AddIntConstant(module, "ENABLE_VIRTUAL_TERMINAL_INPUT", ENABLE_VIRTUAL_TERMINAL_INPUT);
#endif
	...
	PyModule_AddIntConstant(module, "ENABLE_VIRTUAL_TERMINAL_PROCESSING", ENABLE_VIRTUAL_TERMINAL_PROCESSING);
#endif
#ifdef DISABLE_NEWLINE_AUTO_RETURN
	PyModule_AddIntConstant(module, "DISABLE_NEWLINE_AUTO_RETURN", DISABLE_NEWLINE_AUTO_RETURN);
#endif
#ifdef ENABLE_LVB_GRID_WORLDWIDE
	PyModule_AddIntConstant(module, "ENABLE_LVB_GRID_WORLDWIDE", ENABLE_LVB_GRID_WORLDWIDE);
#endif
